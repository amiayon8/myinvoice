...
export const LogoUpload: React.FC<LogoUploadProps> = ({ currentUrl, onUploadSuccess, userId }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 bg-slate-50 dark:bg-slate-900/50 p-4 border-2 border-slate-200 dark:border-slate-800 border-dashed rounded-lg">
      {currentUrl ? (
